...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="text-[#1D2E5C]">
        <main>
            <div class="relative w-full h-screen md:h-[70vh] xl:h-screen 2xl:px-0">
                ...
                <div class="w-full max-w-screen-xl mx-auto p-5 2lx:px-0">
                    <div class="grid grid-cols-12 justify-center items-start gap-[5vw]">
                        <div class="col-span-12 md:col-span-6">
                            <ul>
                                <li>
                                    <img src="{{url('assets/images/logo/white_logo.png')}}" class="w-[20rem]">
                                </li>
                                ...
                                <li>
                                    <p class="text-white font-inter text-[12px] md:text-[16px]">
                                ...
                                <li class="my-2">
                                    <h1 class="text-[14px] md:text-[20px] font-bold text-[#ffffff]">Follow us on</h1>
                        ...
                        <div class="col-span-12 md:col-span-6">
                            <ul>
                                <li>
                                    <div class="bg-[#D9D9D9] w-full min-h-[50px]">
